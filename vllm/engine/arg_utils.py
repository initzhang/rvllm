...
class EngineArgs:
    ...
    scheduling_policy: Literal["fcfs", "priority", "priority_tc", "priority_bs", "priority_abs", "priority_pabs", "priority_ipabs", "priority_iso_pabs", 
            "priority_ada_pabs", "priority_ovlp_pabs", "priority_islt_pabs"] = "fcfs"
    ...
    def add_cli_args(parser: FlexibleArgumentParser) -> FlexibleArgumentParser:
        ...
        parser.add_argument(
            '--scheduling-policy',
            choices=['fcfs', 'priority', 'priority_tc', 'priority_bs', 'priority_abs', 'priority_pabs', 'priority_ipabs', 'priority_iso_pabs', 
    ...
    def create_engine_config(self,
        ...
        if self.scheduling_policy in ["priority_bs", "priority_abs", "priority_pabs", "priority_ipabs", "priority_iso_pabs", 
                "priority_ada_pabs", "priority_islt_pabs", "priority_ovlp_pabs"]:
